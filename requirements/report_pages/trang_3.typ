...
#align(center)[
  #table(
    ...
    [D2.2], [Script phân tích JSON và bộ biểu đồ Histogram (300 DPI)], [`analyze_kaggle_benchmark.py`, `figures_dpi300/hist_*.png`], [#badge-pass([ĐÃ HOÀN THÀNH])],
    ...
    [D2.4], [Bảng Excel thống kê 2.200 ảnh và đo đạc thực nghiệm đa nền tảng (6 Sheet)], [`hardware_benchmark_statistics.xlsx`], [#badge-pass([ĐÃ HOÀN THÀNH])],
    [D2.5], [Thư mục 29 hình ảnh độ phân giải cao 300 DPI (Histogram, ROI, Heatmap)], [`figures_dpi300/`], [#badge-pass([ĐÃ HOÀN THÀNH])],
    ...
    [D2.7], [Hình Fig. 7 Bài báo IEEE: Overlap-Tiling Boundary Ablation (300 DPI)], [`figures_dpi300/fig7_boundary_ablation.png`], [#badge-pass([ĐÃ HOÀN THÀNH])],
    [D2.8], [Hình Fig. 8 Bài báo IEEE: Ma trận so sánh định tính 2 hàng x 7 mô hình (300 DPI)], [`figures_dpi300/fig8_visual_comparison.png`], [#badge-pass([ĐÃ HOÀN THÀNH])]
  )
]
